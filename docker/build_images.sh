...
docker push garystafford/storefront-accounts:$IMAGE_TAG_MINIKUBE
...
docker push garystafford/storefront-orders:$IMAGE_TAG_MINIKUBE
...
docker push garystafford/storefront-fulfillment:$IMAGE_TAG_MINIKUBE
